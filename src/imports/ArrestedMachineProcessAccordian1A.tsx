...
export default function ArrestedMachineProcessAccordian1A() {
  return (
    <div className="bg-[#352c27] relative w-full h-screen overflow-hidden flex flex-col justify-center" data-name="ArrestedMachine_ProcessAccordian-1a">
      {/* Content Container - matching Hero section approach */}
      <div className="relative flex items-center justify-center w-full">
        <div className="relative w-[1369px] max-w-full px-[6.25%] py-16">
          ...
          <div className="relative space-y-4 mb-8 w-full">
            {/* Phase 1 */}
            <div className="relative">
              <div className="bg-[#ffffff] h-[58px] rounded-[5px] w-full relative">
                <div className="absolute bg-[#fcb426] h-[42px] rounded-[5px] left-2 top-2 px-4 flex items-center">
                  <div className="font-['Libre_Franklin:Medium',_sans-serif] font-medium text-[#352c27] text-[16px] tracking-[0.64px] uppercase">
                    Discover & Strategy
                  </div>
                </div>
      ...
      <div
        ...
        style={{ 
          backgroundImage: `url('${imgArrestedMachineLogo2}')`,
          top: 'calc(50% - 200px)', // Align with title baseline
